...
All examples have been compiled on a MacBook Pro with an Apple M2 Max chip and [HDF5](https://www.hdfgroup.org/solutions/hdf5/) 1.14.6
...
set(PythonSupport OFF CACHE BOOL "" FORCE)
...
target_link_libraries(ex h5::h5_c hdf5::hdf5 hdf5::hdf5_hl)
```
